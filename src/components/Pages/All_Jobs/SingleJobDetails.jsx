...
const SingleJobDetails = () => {
    ...
    return (
        <div className="bg-gray-50 shadow-sm mx-auto w-11/12 md:mt-12 md:border rounded md:p-10">
            <Helmet>
                <title>Remoto | Job Details</title>
            </Helmet>
            <div className="flex md:gap-6 flex-col ">
                <div>
                    <img className="rounded w-full" src={job_banner} alt="" />
                </div>
                <div>
                    <div className="flex justify-between align-middle">
                        ...
                        <p className="mt-5  text-xl">Total applied : {job_applicants_number}</p>
                    </div>
                    <p className="mt-6  text-lg"><span className="text-xl">Job Details : </span>{description}</p>
                    <div className="flex justify-between">
                        <p className="mt-10 text-xl font-semibold">Salary: {salary_range[0]}$ - {salary_range[1]}$ (Annual)</p>
                        <div className=" mt-8">
                            <label htmlFor="my_modal_7" className="mt-5 border rounded text-lg font-medium cursor-pointer bg-blue-400 text-white py-2 rounded px-5">Apply Now</label>
                        </div>
                    </div>
                </div>
            </div>
